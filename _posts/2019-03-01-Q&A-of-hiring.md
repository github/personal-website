...
核心是基于区块链的激励机制及peer to peer（P2P）传输技术，汇聚全世界所有可连接的计算资源，并为每一个人所用。有不同的落地方向，其中PPIO是做更高性价比的分布式加密云存储服务，构建基于P2P及区块链技术的去中心化存储和分发网络；平台开放API接口给到第三方开发者开发应用。产品未来推广会面向全球市场，前期可能会以东南亚市场为主。具体可参考 [项目网站（英文）](https://www.pp.io/)。同时内部基于PPIO平台孵化其他的应用方向，主要围绕更快的网络传输（如流媒体加速、边缘CDN）和更高性价比的云存储。
