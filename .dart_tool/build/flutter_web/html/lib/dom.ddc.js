  ...
  html_input_stream.HtmlInputStream = class HtmlInputStream extends core.Object {
    ...
    reset() {
      ...
      for (let c of this[_rawChars]) {
        ...
        if (dart.test(html_input_stream._invalidUnicode(c))) this.errors.add("invalid-codepoint");
    ...
    char() {
      ...
      return core.String.fromCharCodes(JSArrayOfint().of([this[_chars][$_get]((t0 = this[_offset], this[_offset] = dart.notNull(t0) + 1, t0))]));
    }
    peekChar() {
      if (dart.notNull(this[_offset]) >= dart.notNull(this[_chars][$length])) return constants.eof;
