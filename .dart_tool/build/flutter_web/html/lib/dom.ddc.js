define(['dart_sdk', 'packages/source_span/source_span', 'packages/csslib/parser'], function(dart_sdk, packages__source_span__source_span, packages__csslib__parser) {
  ...
  const Node_parentNode = dart.privateName(dom, "Node.parentNode");
  const Node_attributes = dart.privateName(dom, "Node.attributes");
  const Node_nodes = dart.privateName(dom, "Node.nodes");
  const Node_sourceSpan = dart.privateName(dom, "Node.sourceSpan");
  ...
  const parentNode = Node_parentNode;
  const attributes = Node_attributes;
  const nodes = Node_nodes;
  const sourceSpan = Node_sourceSpan;
  ...
  const Element_namespaceUri = dart.privateName(dom, "Element.namespaceUri");
  const Element_localName = dart.privateName(dom, "Element.localName");
  const Element_endSourceSpan = dart.privateName(dom, "Element.endSourceSpan");
  let C0;
  ...
  const namespaceUri$ = Element_namespaceUri;
  const localName$ = Element_localName;
  const endSourceSpan = Element_endSourceSpan;
  ...
  let C10;
  let C13;
  const TreeBuilder_defaultNamespace = dart.privateName(treebuilder, "TreeBuilder.defaultNamespace");
  const TreeBuilder_document = dart.privateName(treebuilder, "TreeBuilder.document");
  const TreeBuilder_openElements = dart.privateName(treebuilder, "TreeBuilder.openElements");
  const TreeBuilder_activeFormattingElements = dart.privateName(treebuilder, "TreeBuilder.activeFormattingElements");
  const TreeBuilder_headPointer = dart.privateName(treebuilder, "TreeBuilder.headPointer");
  const TreeBuilder_formPointer = dart.privateName(treebuilder, "TreeBuilder.formPointer");
  const TreeBuilder_insertFromTable = dart.privateName(treebuilder, "TreeBuilder.insertFromTable");
  ...
  const defaultNamespace = TreeBuilder_defaultNamespace;
  const document = TreeBuilder_document;
  const openElements = TreeBuilder_openElements;
  const activeFormattingElements = TreeBuilder_activeFormattingElements;
  const headPointer = TreeBuilder_headPointer;
  const formPointer = TreeBuilder_formPointer;
  const insertFromTable = TreeBuilder_insertFromTable;
  ...
  const ReparseException_message = dart.privateName(constants, "ReparseException.message");
  ...
  const message$ = ReparseException_message;
  ...
  const TagToken_name = dart.privateName(token$, "TagToken.name");
  const TagToken_selfClosing = dart.privateName(token$, "TagToken.selfClosing");
  ...
  const name$ = TagToken_name;
  const selfClosing$ = TagToken_selfClosing;
  ...
  const StartTagToken_data = dart.privateName(token$, "StartTagToken.data");
  const StartTagToken_attributeSpans = dart.privateName(token$, "StartTagToken.attributeSpans");
  const StartTagToken_selfClosingAcknowledged = dart.privateName(token$, "StartTagToken.selfClosingAcknowledged");
  const StartTagToken_namespace = dart.privateName(token$, "StartTagToken.namespace");
  ...
  const data$ = StartTagToken_data;
  const attributeSpans = StartTagToken_attributeSpans;
  const selfClosingAcknowledged$ = StartTagToken_selfClosingAcknowledged;
  const namespace$ = StartTagToken_namespace;
  ...
  const ParseErrorToken_messageParams = dart.privateName(token$, "ParseErrorToken.messageParams");
  ...
  const messageParams$ = ParseErrorToken_messageParams;
  ...
  const DoctypeToken_publicId = dart.privateName(token$, "DoctypeToken.publicId");
  const DoctypeToken_systemId = dart.privateName(token$, "DoctypeToken.systemId");
  const DoctypeToken_name = dart.privateName(token$, "DoctypeToken.name");
  const DoctypeToken_correct = dart.privateName(token$, "DoctypeToken.correct");
  ...
  const publicId$ = DoctypeToken_publicId;
  const systemId$ = DoctypeToken_systemId;
  const name = DoctypeToken_name;
  const correct$ = DoctypeToken_correct;
  ...
  const TagAttribute_name = dart.privateName(token$, "TagAttribute.name");
  const TagAttribute_value = dart.privateName(token$, "TagAttribute.value");
  const TagAttribute_start = dart.privateName(token$, "TagAttribute.start");
  const TagAttribute_end = dart.privateName(token$, "TagAttribute.end");
  const TagAttribute_startValue = dart.privateName(token$, "TagAttribute.startValue");
  const TagAttribute_endValue = dart.privateName(token$, "TagAttribute.endValue");
  ...
  const name$0 = TagAttribute_name;
  const value$ = TagAttribute_value;
  const start = TagAttribute_start;
  const end = TagAttribute_end;
  const startValue = TagAttribute_startValue;
  const endValue = TagAttribute_endValue;
  ...
  let C155;
  let C143;
  const HtmlParser_strict = dart.privateName(parser$, "HtmlParser.strict");
  const HtmlParser_generateSpans = dart.privateName(parser$, "HtmlParser.generateSpans");
  const HtmlParser_tokenizer = dart.privateName(parser$, "HtmlParser.tokenizer");
  const HtmlParser_tree = dart.privateName(parser$, "HtmlParser.tree");
  const HtmlParser_errors = dart.privateName(parser$, "HtmlParser.errors");
  const HtmlParser_container = dart.privateName(parser$, "HtmlParser.container");
  const HtmlParser_firstStartTag = dart.privateName(parser$, "HtmlParser.firstStartTag");
  const HtmlParser_compatMode = dart.privateName(parser$, "HtmlParser.compatMode");
  const HtmlParser_innerHTML = dart.privateName(parser$, "HtmlParser.innerHTML");
  const HtmlParser_phase = dart.privateName(parser$, "HtmlParser.phase");
  const HtmlParser_lastPhase = dart.privateName(parser$, "HtmlParser.lastPhase");
  const HtmlParser_originalPhase = dart.privateName(parser$, "HtmlParser.originalPhase");
  const HtmlParser_beforeRCDataPhase = dart.privateName(parser$, "HtmlParser.beforeRCDataPhase");
  const HtmlParser_framesetOK = dart.privateName(parser$, "HtmlParser.framesetOK");
  parser$.HtmlParser = class HtmlParser extends core.Object {
    ...
    parseError(span, errorcode, datavars) {
      if (datavars === void 0) datavars = C141 || CT.C141;
  ...
  const strict$ = HtmlParser_strict;
  const generateSpans$ = HtmlParser_generateSpans;
  const tokenizer = HtmlParser_tokenizer;
  const tree$ = HtmlParser_tree;
  const errors = HtmlParser_errors;
  const container = HtmlParser_container;
  const firstStartTag = HtmlParser_firstStartTag;
  const compatMode = HtmlParser_compatMode;
  const innerHTML = HtmlParser_innerHTML;
  const phase = HtmlParser_phase;
  const lastPhase = HtmlParser_lastPhase;
  const originalPhase = HtmlParser_originalPhase;
  const beforeRCDataPhase = HtmlParser_beforeRCDataPhase;
  const framesetOK = HtmlParser_framesetOK;
  ...
  const Phase_parser = dart.privateName(parser$, "Phase.parser");
  const Phase_tree = dart.privateName(parser$, "Phase.tree");
  ...
  const parser$0 = Phase_parser;
  const tree = Phase_tree;
  ...
  let C161;
  let C164;
  const InBodyPhase_dropNewline = dart.privateName(parser$, "InBodyPhase.dropNewline");
  ...
  const dropNewline = InBodyPhase_dropNewline;
  ...
  const InTableTextPhase_originalPhase = dart.privateName(parser$, "InTableTextPhase.originalPhase");
  const InTableTextPhase_characterTokens = dart.privateName(parser$, "InTableTextPhase.characterTokens");
  ...
  const originalPhase$ = InTableTextPhase_originalPhase;
  const characterTokens = InTableTextPhase_characterTokens;
  ...
  const ParseError_errorCode = dart.privateName(parser$, "ParseError.errorCode");
  const ParseError_span = dart.privateName(parser$, "ParseError.span");
  const ParseError_data = dart.privateName(parser$, "ParseError.data");
  ...
  const errorCode$ = ParseError_errorCode;
  const span$0 = ParseError_span;
  const data$0 = ParseError_data;
  ...
  let C176;
  let C177;
  const HtmlTokenizer_stream = dart.privateName(tokenizer$, "HtmlTokenizer.stream");
  const HtmlTokenizer_lowercaseElementName = dart.privateName(tokenizer$, "HtmlTokenizer.lowercaseElementName");
  const HtmlTokenizer_lowercaseAttrName = dart.privateName(tokenizer$, "HtmlTokenizer.lowercaseAttrName");
  const HtmlTokenizer_generateSpans = dart.privateName(tokenizer$, "HtmlTokenizer.generateSpans");
  const HtmlTokenizer_attributeSpans = dart.privateName(tokenizer$, "HtmlTokenizer.attributeSpans");
  const HtmlTokenizer_parser = dart.privateName(tokenizer$, "HtmlTokenizer.parser");
  const HtmlTokenizer_tokenQueue = dart.privateName(tokenizer$, "HtmlTokenizer.tokenQueue");
  const HtmlTokenizer_currentToken = dart.privateName(tokenizer$, "HtmlTokenizer.currentToken");
  const HtmlTokenizer_state = dart.privateName(tokenizer$, "HtmlTokenizer.state");
  ...
  const stream = HtmlTokenizer_stream;
  const lowercaseElementName$ = HtmlTokenizer_lowercaseElementName;
  const lowercaseAttrName$ = HtmlTokenizer_lowercaseAttrName;
  const generateSpans$0 = HtmlTokenizer_generateSpans;
  const attributeSpans$ = HtmlTokenizer_attributeSpans;
  const parser$1 = HtmlTokenizer_parser;
  const tokenQueue = HtmlTokenizer_tokenQueue;
  const currentToken = HtmlTokenizer_currentToken;
  const state = HtmlTokenizer_state;
  ...
  const HtmlInputStream_charEncodingName = dart.privateName(html_input_stream, "HtmlInputStream.charEncodingName");
  const HtmlInputStream_charEncodingCertain = dart.privateName(html_input_stream, "HtmlInputStream.charEncodingCertain");
  const HtmlInputStream_generateSpans = dart.privateName(html_input_stream, "HtmlInputStream.generateSpans");
  const HtmlInputStream_sourceUrl = dart.privateName(html_input_stream, "HtmlInputStream.sourceUrl");
  const HtmlInputStream_errors = dart.privateName(html_input_stream, "HtmlInputStream.errors");
  const HtmlInputStream_fileInfo = dart.privateName(html_input_stream, "HtmlInputStream.fileInfo");
  ...
  const charEncodingName = HtmlInputStream_charEncodingName;
  const charEncodingCertain = HtmlInputStream_charEncodingCertain;
  const generateSpans$1 = HtmlInputStream_generateSpans;
  const sourceUrl$ = HtmlInputStream_sourceUrl;
  const errors$ = HtmlInputStream_errors;
  const fileInfo = HtmlInputStream_fileInfo;
  ...
  const ContentAttrParser_data = dart.privateName(encoding_parser, "ContentAttrParser.data");
  ...
  const data$1 = ContentAttrParser_data;
  ...
  const DocumentType_name = dart.privateName(dom, "DocumentType.name");
  const DocumentType_publicId = dart.privateName(dom, "DocumentType.publicId");
  const DocumentType_systemId = dart.privateName(dom, "DocumentType.systemId");
  ...
  const name$2 = DocumentType_name;
  const publicId$0 = DocumentType_publicId;
  const systemId$0 = DocumentType_systemId;
  ...
  const Comment_data = dart.privateName(dom, "Comment.data");
