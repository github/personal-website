define(['dart_sdk'], function(dart_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C5() {
      return C5 = dart.constList([C0 || CT.C0, C1 || CT.C1, C2 || CT.C2, C3 || CT.C3, C4 || CT.C4], storage.TaskState);
    },
    get C6() {
      return C6 = dart.fn(storage.FullMetadata.getInstance, dynamicToFullMetadata());
    },
    get C7() {
      return C7 = dart.fn(storage.UploadTaskSnapshot.getInstance, UploadTaskSnapshotJsImplToUploadTaskSnapshot());
    },
    get C8() {
      return C8 = dart.fn(database.DatabaseReference.getInstance, ReferenceJsImplToDatabaseReferenceOfReferenceJsImpl());
    },
    get C9() {
      return C9 = dart.fn(utils.jsify, ObjectTodynamic());
    },
    get C10() {
      return C10 = dart.fn(utils.dartify, ObjectTodynamic());
    },
    get C11() {
      return C11 = dart.fn(firestore.DocumentSnapshot.getInstance, DocumentSnapshotJsImplToDocumentSnapshot());
    },
    get C12() {
      return C12 = dart.fn(firestore.QuerySnapshot.getInstance, QuerySnapshotJsImplToQuerySnapshot());
    },
    get C13() {
      return C13 = dart.fn(firestore.DocumentReference.getInstance, DocumentReferenceJsImplToDocumentReference());
    },
    get C14() {
      return C14 = dart.fn(auth$.User.getInstance, UserJsImplToUser());
    }
  });
  ...
  storage.StorageReference = class StorageReference extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.storage.Reference, "firebase.storage.Reference")) {
    ...
    getMetadata() {
      return utils.handleThenable(dart.anonymousJSType("FullMetadataJsImpl"), this.jsObject.getMetadata()).then(storage.FullMetadata, C6 || CT.C6);
    }
    put(blob, metadata) {
    ...
    updateMetadata(metadata) {
      return utils.handleThenable(dart.anonymousJSType("FullMetadataJsImpl"), this.jsObject.updateMetadata(metadata.jsObject)).then(storage.FullMetadata, C6 || CT.C6);
    }
  };
  ...
  storage._SettableMetadataBase$ = dart.generic(T => {
    class _SettableMetadataBase extends js$.JsObjectWrapper$(T) {
      ...
      get customMetadata() {
        let t0;
        t0 = core.Map.as(utils.dartify(this.jsObject.customMetadata));
        return t0 == null ? null : t0[$cast](core.String, core.String);
      }
  ...
  storage.UploadTask = class UploadTask extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.storage.UploadTask, "firebase.storage.UploadTask")) {
    get future() {
      let t0;
      t0 = this[_future];
      return t0 == null ? this[_future] = utils.handleThenable(dart.anonymousJSType("UploadTaskSnapshotJsImpl"), this.jsObject).then(storage.UploadTaskSnapshot, C7 || CT.C7) : t0;
    }
    get snapshot() {
  ...
  database.ThenableReference = class ThenableReference extends database.DatabaseReference$(dart.lazyJSType(() => dart.global.firebase.database.ThenableReference, "firebase.database.ThenableReference")) {
    get future() {
      let t0;
      t0 = this[_future$];
      return t0 == null ? this[_future$] = utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.database.Reference, "firebase.database.Reference"), this.jsObject).then(DatabaseReferenceOfReferenceJsImpl(), C8 || CT.C8) : t0;
    }
  };
  ...
  firestore.Firestore = class Firestore extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.firestore.Firestore, "firebase.firestore.Firestore")) {
    ...
    static getInstance(jsObject) {
      ...
      t1 = jsObject;
      t2 = t0._get(t1);
      return t2 == null ? (t3$ = new firestore.Firestore._fromJsObject((t3 = jsObject, t3.settings({timestampsInSnapshots: true}), t3)), t0._set(t1, t3$), t3$) : t2;
    }
    batch() {
  ...
  const JsObjectWrapper__Updatable$ = class JsObjectWrapper__Updatable extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.firestore.WriteBatch, "firebase.firestore.WriteBatch")) {};
  ...
  dart.applyMixin(JsObjectWrapper__Updatable$, firestore._Updatable);
  firestore.WriteBatch = class WriteBatch extends JsObjectWrapper__Updatable$ {
    static getInstance(jsObject) {
      let t3, t2, t1, t0;
      if (jsObject == null) {
        return null;
  ...
  const JsObjectWrapper__Updatable$$ = class JsObjectWrapper__Updatable extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.firestore.DocumentReference, "firebase.firestore.DocumentReference")) {};
  (JsObjectWrapper__Updatable$$.fromJsObject = function(jsObject) {
    JsObjectWrapper__Updatable$$.__proto__.fromJsObject.call(this, jsObject);
  }).prototype = JsObjectWrapper__Updatable$$.prototype;
  dart.applyMixin(JsObjectWrapper__Updatable$$, firestore._Updatable);
  firestore.DocumentReference = class DocumentReference extends JsObjectWrapper__Updatable$$ {
    get firestore() {
      return firestore.Firestore.getInstance(this.jsObject.firestore);
    }
    get id() {
    ...
    get() {
      return utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.firestore.DocumentSnapshot, "firebase.firestore.DocumentSnapshot"), this.jsObject.get()).then(firestore.DocumentSnapshot, C11 || CT.C11);
    }
    get onSnapshot() {
  ...
  firestore.Query$ = dart.generic(T => {
    class Query extends js$.JsObjectWrapper$(T) {
      ...
      get() {
        return utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.firestore.QuerySnapshot, "firebase.firestore.QuerySnapshot"), this.jsObject.get()).then(firestore.QuerySnapshot, C12 || CT.C12);
      }
      limit(limit) {
      ...
      [_wrapPaginatingFunctionCall](method, snapshot, fieldValues) {
        ...
        let args = snapshot != null ? JSArrayOfDocumentSnapshotJsImpl().of([snapshot.jsObject]) : fieldValues[$map](dart.dynamic, C9 || CT.C9)[$toList]();
  ...
  firestore.CollectionReference$ = dart.generic(T => {
    class CollectionReference extends firestore.Query$(T) {
      ...
      static getInstance(jsObject) {
        ...
        t1 = jsObject;
        t2 = t0._get(t1);
        return t2 == null ? (t3 = new (CollectionReferenceOfCollectionReferenceJsImpl())._fromJsObject(jsObject), t0._set(t1, t3), t3) : t2;
      }
      static new() {
        return new (firestore.CollectionReference$(T))._fromJsObject(new dart.global.firebase.firestore.CollectionReference());
      }
      add(data) {
        return utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.firestore.DocumentReference, "firebase.firestore.DocumentReference"), this.jsObject.add(utils.jsify(data))).then(firestore.DocumentReference, C13 || CT.C13);
      }
      doc(documentPath) {
  ...
  const JsObjectWrapper__Updatable$$0 = class JsObjectWrapper__Updatable extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.firestore.Transaction, "firebase.firestore.Transaction")) {};
  ...
  dart.applyMixin(JsObjectWrapper__Updatable$$0, firestore._Updatable);
  firestore.Transaction = class Transaction extends JsObjectWrapper__Updatable$$0 {
    static getInstance(jsObject) {
      let t3, t2, t1, t0;
      if (jsObject == null) {
        return null;
    ...
    get(documentRef) {
      return utils.handleThenable(dart.lazyJSType(() => dart.global.firebase.firestore.DocumentSnapshot, "firebase.firestore.DocumentSnapshot"), this.jsObject.get(documentRef.jsObject)).then(firestore.DocumentSnapshot, C11 || CT.C11);
    }
    set(documentRef, data, options) {
      if (options === void 0) options = null;
      let jsObjectSet = options != null ? this.jsObject.set(documentRef.jsObject, utils.jsify(data), options) : this.jsObject.set(documentRef.jsObject, utils.jsify(data));
  ...
  utils.dartify = function dartify(jsObject) {
    ...
    if (core.Iterable.is(jsObject)) {
      return jsObject[$map](dart.dynamic, C10 || CT.C10)[$toList]();
    }
  ...
  utils.jsifyList = function jsifyList(list) {
    return dart.global.Array.from(list[$map](dart.dynamic, C9 || CT.C9)[$toList]());
  };
  ...
  auth$.User = class User extends auth$.UserInfo$(dart.anonymousJSType("UserJsImpl")) {
    ...
    linkWithCredential(credential) {
      return utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.linkWithCredential(credential)).then(auth$.User, C14 || CT.C14);
    }
    ...
    unlink(providerId) {
      return utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.unlink(providerId)).then(auth$.User, C14 || CT.C14);
    }
  ...
  auth$.Auth = class Auth extends js$.JsObjectWrapper$(dart.lazyJSType(() => dart.global.firebase.auth.Auth, "firebase.auth.Auth")) {
    ...
    signInWithCredential(credential) {
      return utils.handleThenable(dart.anonymousJSType("UserJsImpl"), this.jsObject.signInWithCredential(credential)).then(auth$.User, C14 || CT.C14);
    }
