define(['dart_sdk', 'packages/firebase/src/app'], function(dart_sdk, packages__firebase__src__app) {
  ...
  const FirebaseJsNotLoadedException_message = dart.privateName(top_level, "FirebaseJsNotLoadedException.message");
  ...
  const message$ = FirebaseJsNotLoadedException_message;
