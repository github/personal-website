define(['dart_sdk'], function(dart_sdk) {
  ...
  repeat.RepeatStream$ = dart.generic(T => {
    ...
    class RepeatStream extends async.Stream$(T) {
      ...
      repeatNext() {
        ...
        try {
          this.subscription = this.streamFactory((t2 = this.repeatStep, this.repeatStep = dart.notNull(t2) + 1, t2)).listen(dart.bind(this.controller, 'add'), {onError: dart.bind(this.controller, 'addError'), onDone: onDone, cancelOnError: false});
        } catch (e$) {
          let e = dart.getThrown(e$);
          let s = dart.stackTrace(e$);
  ...
  const SequenceEqualStream_controller = dart.privateName(sequence_equal, "SequenceEqualStream.controller");
  sequence_equal.SequenceEqualStream$ = dart.generic((S, T) => {
    ...
    const controller = SequenceEqualStream_controller;
